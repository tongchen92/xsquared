...
function ensureStore() {
  ...
  if (!existsSync(STORE_PATH)) {
    writeFileSync(STORE_PATH, JSON.stringify({ version: 1, posts: [], trendSnapshots: [], rewriteRequests: [] }, null, 2));
  }
}
